...
import io.hasura.sdk.request.ConfirmEmailRequest;
import io.hasura.sdk.request.ConfirmMobileRequest;
import io.hasura.sdk.request.ForgotPasswordRequest;
import io.hasura.sdk.request.LoginRequest;
import io.hasura.sdk.request.ResendEmailRequest;
import io.hasura.sdk.request.ResendOTPRequest;
import io.hasura.sdk.request.ResetPasswordRequest;
import io.hasura.sdk.request.SocialLoginRequest;
import io.hasura.sdk.response.AuthResponse;
import io.hasura.sdk.response.ConfirmEmailResponse;
import io.hasura.sdk.response.ConfirmMobileResponse;
import io.hasura.sdk.response.ForgotPasswordResponse;
import io.hasura.sdk.response.LoginResponse;
import io.hasura.sdk.response.MessageResponse;
import io.hasura.sdk.response.ResendOTPResponse;
import io.hasura.sdk.response.ResetPasswordResponse;
import io.hasura.sdk.response.SocialLoginResponse;
...
public class AnonymousUserService extends HasuraHttpService {
    ...
    public Call<AuthResponse, HasuraException> signUp(AuthRequest r) {
        ...
        return makePostCall(HasuraConfig.URL.SIGNUP, jsonBody, respType);
    }
    ...
    public Call<AuthResponse, HasuraException> signUpForMobileOtp(AuthRequest r) {
        ...
        return makePostCall(HasuraConfig.URL.SIGNUP_MOBILE, jsonBody, respType);
    }
    ...
    public Call<MessageResponse, HasuraException> sendOtpToMobile(AuthRequest r) {
        String jsonBody = gson.toJson(r);
        Type respType = new TypeToken<AuthResponse>() {}.getType();
        return makePostCall(HasuraConfig.URL.LOGIN_MOBILE, jsonBody, respType);
    }
